...
const config = {
  ...
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=1001821855990157342&permissions=0&scope=bot",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
  ...
  discordLink: "https://dsc.gg/ytsunrise",
  youtubeLink: "https://www.youtube.com/lulamcshorts",
};
